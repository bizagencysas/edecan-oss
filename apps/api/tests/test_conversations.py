...
# --------------------------------------------------------------------------
# GET /main -- conversación "principal" (frente 5, paridad Aria)
# --------------------------------------------------------------------------
...
def _un_modelo_ciego() -> str:
    from edecan_llm.task_router import modelos_chat_disponibles

    return next(row["id"] for row in modelos_chat_disponibles() if not row["ve_imagenes"])
