...
async def test_get_credentials_expone_workers_ai_sin_secreto(client, app) -> None:
    ...
    assert body["llm"] == {
        "kind": "workers_ai",
        "model_principal": "@cf/zai-org/glm-4.7-flash",
        "model_rapido": "@cf/zai-org/glm-4.7-flash",
        "model_profundo": "@cf/zai-org/glm-4.7-flash",
...
async def test_get_modelos_declara_seleccion_automatica(client, app) -> None:
    ...
    assert body["models"] == ["@cf/zai-org/glm-4.7-flash"]
