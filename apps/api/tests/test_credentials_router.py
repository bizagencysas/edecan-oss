...
async def test_get_credentials_expone_workers_ai_sin_secreto(client, app) -> None:
    ...
    assert body["llm"] == {
        "kind": "workers_ai",
        "model_principal": "@cf/meta/llama-4-scout-17b-16e-instruct",
        "model_rapido": "@cf/meta/llama-4-scout-17b-16e-instruct",
        "model_profundo": "@cf/meta/llama-4-scout-17b-16e-instruct",
...
async def test_get_modelos_declara_seleccion_automatica(client, app) -> None:
    ...
    assert body["models"] == ["@cf/meta/llama-4-scout-17b-16e-instruct"]
