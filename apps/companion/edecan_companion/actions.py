...
def _screenshot_via_screencapture(
    ...
    Aria, pero aquí se ejecuta sin shell, con timeout, archivo temporal
    ...
    # una sucesion de avisos. Aria evita ese bucle porque su proceso ya
...
#      defecto, y con `format: "jpeg"` el resize corre SIEMPRE) y es ese
#      tamaño reducido el que viaja al teléfono como `width`/`height`.
...
#
# La solución (la misma que usa Aria): el teléfono manda una FRACCIÓN
