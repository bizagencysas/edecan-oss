...
def _cuentas_windows_candidatas() -> list[str]:
    """Copia deliberada de ``ide_opencode_config._cuentas_windows_candidatas``
    -- ver el docstring de esa función para la explicación completa del
    hallazgo (``USERDOMAIN=WORKGROUP`` no resuelve en icacls, error 1332
    confirmado en vivo) y de por qué ``.\\usuario`` es el candidato de
    respaldo universal."""
