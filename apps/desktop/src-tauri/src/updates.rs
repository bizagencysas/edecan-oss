...
const STABLE_ENDPOINT: &str =
    "https://raw.githubusercontent.com/your-org/edecan-oss/update-channels/stable.json";
const PREVIEW_ENDPOINT: &str =
    "https://raw.githubusercontent.com/your-org/edecan-oss/update-channels/preview.json";
