...
class PairingDeepLinkTest {
    ...
    fun politicaAceptaLocalesYHttpsPublico() {
        ...
        assertEquals("http://MacBook-Pruebas:9876", validarUrlServidor("http://MacBook-Pruebas:9876"))
        assertEquals("http://macbook-pruebas.local:9876", validarUrlServidor("http://macbook-pruebas.local:9876"))
