...
final class ChatViewModel {
    ...
    /// Arranca el chat. Sin un `preferredConversationId` explícito (p. ej. un
    /// deeplink) ni un intento pendiente que recuperar, deliberadamente NO
    /// reabre la última conversación: la app en frío aterriza en un chat
    /// nuevo y vacío (Frente 4). El historial sigue intacto y accesible por
    /// el botón de conversaciones; solo cambia dónde se aterriza.
