...
struct NavegadorEnApp: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: Context) -> SFSafariViewController {
        ...
        // `preferredControlTintColor` quedó deprecated en iOS 26; Safari
        // controla sus tintes dentro de su proceso y no necesita que Edecán
        // fuerce ese color para garantizar el dominio visible.
        return controller
    }
