    ...
    var body: some View {
        ...
        .onChange(of: push.rutaPendiente) { _, route in
            ...
            case .activity:
                ...
                // vivo encima de Actividad; cualquier otro aviso de Actividad
                // (misión, automatización, recordatorio, resumen de llamada
                // ya terminada) se queda con el comportamiento de siempre.
