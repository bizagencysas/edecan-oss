...
/// Llamada en curso vista en vivo (frente 6c, paridad REFERENCIA): turnos de la
...
///
/// DIFERENCIA con REFERENCIA: REFERENCIA corre Pipecat en tiempo real sobre
/// WebSocket, así que el susurro se inyecta al instante. Edecán conversa por
/// TURNOS vía webhooks de Twilio (`docs`/`plan-paridad-referencia.local.md`
