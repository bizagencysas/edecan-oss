...
struct PerfilView: View {
        ...
        NavigationStack {
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    tarjetaDeEdecan
                    seccionMemoria
                    NavigationLink { PrivacidadView() } label: {
                        fila(icono: "hand.raised.fill", titulo: "Privacidad", subtitulo: "Exporta tus datos o elimina tu memoria")
                    }
                    .buttonStyle(.plain)
    ...
    private var seccionMemoria: some View {
        NavigationLink {
            MemoriaView()
        } label: {
            HStack(spacing: 14) {
    ...
    private var herramientas: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            Button {
                ...
                fila(icono: "briefcase.fill", titulo: "LinkedIn", subtitulo: "Personal y de organización, con imagen, copy y aprobación")
            }
            .buttonStyle(.plain)
