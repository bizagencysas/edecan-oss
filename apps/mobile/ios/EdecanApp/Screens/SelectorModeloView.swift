...
struct SelectorModeloView: View {
    ...
    var body: some View {
        NavigationStack {
            List {
                ...
                if let catalogo = viewModel.catalogoModelos {
                    Section {
                        ...
                        // de verdad (`soporta_esfuerzo`): en Scout o en
            ...
            .task { await viewModel.cargarCatalogoModelos(client: session.client, forzar: true) }
            .refreshable { await viewModel.cargarCatalogoModelos(client: session.client, forzar: true) }
        }
