...
public struct MobileServerConfig: Codable, Sendable, Equatable {
    ...
    public static let fallback = MobileServerConfig(
        ...
        tabs: [
            ...
            MobileTabConfig(id: "activity", title: "Actividad", systemIcon: "clock.arrow.circlepath", order: 1),
            MobileTabConfig(id: "ide", title: "IDE", systemIcon: "chevron.left.forwardslash.chevron.right", order: 2),
            MobileTabConfig(id: "profile", title: "Tú", systemIcon: "person.crop.circle.fill", order: 3),
        ],
