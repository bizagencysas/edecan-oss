...
struct TextoRicoMarkdownTests {
    private func parsearTabla(_ texto: String) -> TablaRica? {
    ...
    func sinBarrasExteriores() throws {
        let tabla = try #require(parsearTabla("a | b | c\n:-: | :-- | --:\n1 | 2 | 3"))
    ...
    func barrasEscapadas() throws {
        ...
        let tabla = try #require(parsearTabla("| x | y |\n| --- | --- |\n| a \\| b | c |"))
    ...
    func topeDeFilas() throws {
        ...
        let tabla = try #require(parsearTabla(texto))
    ...
    func etiquetasRepetidas() throws {
        let tabla = try #require(parsearTabla("| Mes | Ventas |\n| --- | --- |\n| Enero | 1 |\n| Enero | 2 |"))
        let grafica = try #require(TextoRicoParser.grafica(de: tabla))
