...
import { CheckIcon, ChevronDownIcon, FileIcon, MicIcon, PlusIcon, RetryIcon, SendIcon, SquareIcon, XIcon } from "@/components/icons";
...
export function ChatComposer({
  ...
  /** Texto de la pastilla del selector ("Oda · Alto", "Copla", "Automático").
        ...
        <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_8px_30px_rgba(15,23,42,0.08)] transition-colors focus-within:border-brand-400 focus-within:ring-2 focus-within:ring-brand-500/10 dark:border-slate-700 dark:bg-slate-900">
          ...
          <div className="flex items-center justify-between gap-3 px-2.5 pb-2.5">
            <div className="flex items-center gap-1.5">
              ...
              {/* El recordatorio del teclado cede el sitio a la pastilla en
                  pantallas medianas: el modelo activo importa más que un tip
                  que ya se aprendió. */}
