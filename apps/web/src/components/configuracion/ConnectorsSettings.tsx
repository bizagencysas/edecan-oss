...
export function ConnectorsSettings({ embedded = false }: { embedded?: boolean }) {
  return (
    <Suspense
      fallback={
        embedded ? (
    ...
    >
      <ConectoresContent embedded={embedded} />
    </Suspense>
  );
}

function ConectoresContent({ embedded }: { embedded: boolean }) {
