...
class Settings(BaseSettings):
    ...
    WORKERS_AI_CHAT_MODEL: str = "@cf/zai-org/glm-4.7-flash"
    ...
    # --- Imágenes de posts: gpt-image-2 (portado de Aria) ------------------
    # El post COMPLETO se le pasa a gpt-image-2 como "director de arte" y ÉL crea
    # la metáfora conceptual con logos reales (como Aria `_generar_imagen_libre`).
