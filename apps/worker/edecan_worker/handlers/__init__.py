...
_register_defensive(HANDLERS, "run_persistent_agent", "run_persistent_agent")
_register_defensive(HANDLERS, "persistent_agent_scan", "persistent_agent_scan")

# Post de LinkedIn en segundo plano (motor "profundo"/nemotron + gpt-image-2 +
# card + push al chat principal). Defensivo porque importa `edecan_creative`,
# que puede no estar en algún despliegue mínimo del worker.
_register_defensive(HANDLERS, "create_linkedin_post", "create_linkedin_post")
