...
# Post de LinkedIn en segundo plano (motor "profundo"/nemotron + Flux + card +
# push al chat principal). Defensivo porque importa `edecan_creative`, que
# puede no estar en algún despliegue mínimo del worker.
