...
async def _tick_persistent_agents(settings: Settings) -> None:
...
async def run_forever(
    ...
    while not stop_event.is_set():
        ...
        if ahora - ultimo_tick_persistent_agents >= INTERVALO_SEGUNDOS_PERSISTENT_AGENTS:
            ultimo_tick_persistent_agents = ahora
            try:
