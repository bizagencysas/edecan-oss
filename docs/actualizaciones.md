...
paquete descargado. El mismo límite protege el corpus creado por una
[migración privada](./migracion-asistente-privada.md): actualizar binarios no
lo vuelve a empaquetar ni lo publica.
...
distintos. Este repositorio no incluye claves, certificados ni automatización
de firma o notarización de cuentas de plataforma. Cada distribuidor debe
configurar ese proceso en su infraestructura privada.

## Publicar una versión

La automatización de publicación firmada no forma parte del repositorio
público. Los scripts públicos generan artefactos y manifiestos verificables;
la custodia de claves y la publicación final pertenecen al operador.
