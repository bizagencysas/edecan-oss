...
| **Compromiso de Edecán** | Edecán crea copy e imágenes para LinkedIn sin acceder a la cuenta. Para leer o publicar acepta únicamente una integración oficial autorizada, cuando el operador tenga acceso y scopes aprobados, o una acción puntual en una sesión local ya abierta mediante `usar_computadora`, visible y confirmada por la persona. El extractor HTTP genérico no scrapea LinkedIn; tampoco se permite extracción masiva, spam, contacto masivo ni engagement artificial. Ver [`../conectores.md`](../conectores.md) sección "LinkedIn: creación y publicación controlada". |
