...
### LinkedIn — creación y vías autorizadas

| | Detalle |
|---|---|
| **Qué permite la API oficial** | Los productos self-service "Sign in with LinkedIn using OpenID Connect" y "Share on LinkedIn" permiten identificar a la persona autorizada, cargar una imagen y publicar en su nombre con `w_member_social`. Otras capacidades de marketing, organizaciones, anuncios y lectura extensa siguen sujetas a aprobación adicional. |
...
| **Compromiso de Edecán** | Edecán crea copy e imágenes privadas para revisión y publica solo mediante el conector OAuth oficial, con confirmación explícita para cada publicación. El extractor HTTP genérico no scrapea LinkedIn; tampoco se permite extracción masiva, spam, contacto masivo ni engagement artificial. Ver [`../conectores.md`](../conectores.md) sección "LinkedIn: creación y publicación controlada". |
