...
**iPhone y Android** — el IDE es **una pestaña del tab bar**, como en Referencia. No una app aparte.
...
- `bench/{edecan,organization}.py` — 30 tareas reales sobre los dos repos, en TypeScript, Swift,
...
| La migración de Referencia | `docs/handoff-forge.md` (este archivo) |
...
### T5 — Si sobra noche: la migración de Referencia como banco

Cada capacidad movida de Referencia a Edecán es una tarea con verificación evidente: ¿sigue
...
- **No quites `codex_cli` todavía.** No por prudencia —Edecán no está en producción y Referencia sigue
