...
2. **Agente**: ejecuta el agente de ingeniería administrado dentro del
   proyecto, muestra herramientas, aprobaciones, acciones y resultados en vivo
   y permite volver a cualquier sesión anterior.
...
Edecán elige automáticamente el modelo de ingeniería según la entrada: texto,
visión o herramientas. El usuario no administra nombres de modelos. El runtime
trabaja dentro del workspace autorizado y transforma su stream en una
cronología legible:
