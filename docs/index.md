...
> **Empieza aquí:** [`guia-completa.md`](./guia-completa.md) reúne en un solo
> recorrido la instalación de macOS, Windows, Linux, iOS y Android, pairing,
> IA, voz, llamadas, IDE, autorreparación, control remoto, nube, rutas HTTP,
> secretos, pruebas y solución de problemas.

## Producto

| Documento | Para qué sirve |
|---|---|
| [`guia-completa.md`](./guia-completa.md) | Manual canónico de uso, instalación, configuración, operación y desarrollo de todo Edecán. |
...
| [`configuracion-minima.md`](./configuracion-minima.md) | Workers AI administrado, matriz de credenciales opcionales e instalación móvil local. |
| [`migracion-asistente-privada.md`](./migracion-asistente-privada.md) | Importación local e idempotente de perfil, memoria, conversaciones, agentes y preferencias desde otra instalación, sin publicar datos personales en Git. |
...
| [`online-node.md`](./online-node.md) | Ejecutar el núcleo OSS completo en un servidor personal para mantener chat, memoria, trabajos y telefonía aun cuando la computadora esté apagada. |
| [`continuidad-hibrida.md`](./continuidad-hibrida.md) | Arquitectura económica Mac-first: borde privado en Cloudflare, relay y fallback básico en AWS, con límites explícitos. |
...
| [`actualizaciones.md`](./actualizaciones.md) | Actualizaciones firmadas sin reclonar, canales estable/vista previa y rollback hacia adelante. |
| [`migracion-asistente-privada.md`](./migracion-asistente-privada.md) | Migrar continuidad privada desde otro asistente con dry-run, confirmación de propietario y credenciales opt-in. |
...
| [`credenciales.md`](./credenciales.md) | Pantalla de "Configuración": voz, imágenes, búsqueda y conectores opcionales; la inferencia LLM es administrada. |
| [`proveedores-llm.md`](./proveedores-llm.md) | Workers AI, selección automática de tareas y contrato genérico `LLMProvider`. |
