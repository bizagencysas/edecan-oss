...
```text
https://raw.githubusercontent.com/your-org/edecan-oss/update-channels/android-stable.json
```
...
```text
https://raw.githubusercontent.com/your-org/edecan-oss/update-channels/android-preview.json
```
