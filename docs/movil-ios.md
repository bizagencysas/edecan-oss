...
```text
https://raw.githubusercontent.com/your-org/edecan-oss/update-channels/ios-stable.json
```

Los builds preliminares usan el puntero análogo:

```text
https://raw.githubusercontent.com/your-org/edecan-oss/update-channels/ios-preview.json
```
...
xcodebuild \
  ...
  EDECAN_IOS_UPDATE_MANIFEST_URL=https://raw.githubusercontent.com/your-org/edecan-oss/update-channels/ios-preview.json \
  ...
```
