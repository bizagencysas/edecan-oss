/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 56f0b1babe32f44c0ea5a6a7849dd4cf)
// Runtime types generated with workerd@1.20260820.1 2026-07-27 nodejs_compat
interface __BaseEnv_Env {
	ENVIRONMENT: "staging" | "production" | "local";
	LOCAL_ORIGIN_URL: string;
	LOCAL_ORIGIN_KEY: string;
	AWS_ORIGIN_URL: string;
	AWS_ORIGIN_KEY: string;
	JWT_VERIFICATION_SECRET: string;
	IDE_SESSION_CONTINUITY: DurableObjectNamespace<import("./src/index").IdeSessionContinuity>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "IdeSessionContinuity";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "LOCAL_ORIGIN_URL" | "LOCAL_ORIGIN_KEY" | "AWS_ORIGIN_URL" | "AWS_ORIGIN_KEY" | "JWT_VERIFICATION_SECRET">> {}
}
