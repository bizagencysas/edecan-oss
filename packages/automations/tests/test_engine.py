...
def test_validate_accion_acepta_create_linkedin_post_valida() -> None:
    # Segunda variante (paridad Aria, ver docstring de
    ...
    validate_accion({"kind": "create_linkedin_post", "destino": "acme"})
...
def test_compute_next_run_los_5_slots_del_sembrado_caen_donde_dice_el_plan() -> None:
    # Paso 1 de `plan-aria-2.0.local.md`: 9/11/13/15/17 de Bogotá deben caer
