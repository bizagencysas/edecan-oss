"""`get_all_tools()` — catálogo de las 4 herramientas (nombres/flags/`dangerous` pinned)."""
...
def test_get_all_tools_devuelve_los_4_nombres_pinned_sin_duplicados():
    tools = get_all_tools()
...
def test_las_4_tools_requieren_el_flag_commerce_orders():
    for tool in get_all_tools():
