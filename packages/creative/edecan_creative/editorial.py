...
ESTRUCTURA
- Una sola idea por post. Entre 55 y 170 palabras; la longitud cambia según el tema, nunca
  rellenes para llegar a un mínimo.
...
def revisar(
    ...
    *,
    ...
    nombre_filtrado = _menciona_nombre_del_banco(
        texto, _nombres_propios_del_banco(banco_privado)
    )
