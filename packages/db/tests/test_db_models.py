...
def test_hay_exactamente_53_tablas_pinned():
...
def test_global_y_rls_particionan_todas_las_tablas_sin_solaparse():
    ...
    # 20 de v1 + 14 de v2 + 1 de v3 + 3 de v4 + 5 de v5 + 2 de v6 + 3 de
    # telefonía + 1 perfil editorial + 1 borrador social (ninguna de las tablas
    # nuevas es global, ver ROADMAP_V2.md §7.4/ARCHITECTURE.md §12e/§13/§14/§15:
    # todas tenant-scoped, sin excepción declarada).
    assert len(RLS_TABLES) == 50
