...
UMBRALES_FASE_0: tuple[Umbral, ...] = (
    ...
    Umbral(
        ...
        descripcion=(
            "Tareas del banco real (Edecán + Acme) resueltas con criterio "
...
class BenchTask(BaseModel):
    ...
    El banco se construye sobre `edecan` y sobre una ruta Acme configurable
    (TypeScript + Next.js, Swift, Kotlin, SQL) para que las mediciones se hagan
    sobre el código que Forge va a tener que tocar de verdad, no sobre katas.
    """

    id: str
    repo: Literal["edecan", "acme"]
    titulo: str
    enunciado: str
