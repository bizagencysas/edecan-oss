...
adaptador de proveedor. La convención interna de `ChatMessage.content` cuando
es una lista de bloques (en vez de `str`) es:
...
Cada adaptador traduce desde/hacia esta forma común y su formato de wire API.
"""
...
StreamChunkType = Literal["text", "tool_call", "usage", "stop", "reasoning"]
