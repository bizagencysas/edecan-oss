...
class CLINotInstalledError(LLMError):
    """El binario de un adaptador CLI no está instalado o no se encuentra.

    Usada por proveedores de procesos locales antiguos cuando ni el
...
class CLINotAuthenticatedError(LLMError):
    ...
    sugiere que falta iniciar sesión en el proveedor correspondiente.
    """
