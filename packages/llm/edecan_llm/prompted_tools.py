...
tool-schemas nativos (proveedores locales antiguos, WP-V3-03).

Algunos adaptadores de texto no tienen una API de tool-use
...
def render_prompt(req: CompletionRequest) -> str:
    ...
    Usado por proveedores locales antiguos: su modo no interactivo
    de un solo turno, así que todo el
