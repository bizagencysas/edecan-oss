...
JOB_TYPES: tuple[str, ...] = (
    ...
    # El post de LinkedIn se genera en SEGUNDO PLANO (no inline en el chat):
    # el atajo del chat resuelve el destino y encola esto; el worker corre el
    # motor completo (escritor "profundo" + auditor + gates + imagen) con
