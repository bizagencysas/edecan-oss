        ...
        "raiz": {
            ...
            "hijos": [
                ...
                },
                {
                    ...
                    "artifact": {
                        "file_id": str(uuid4()),
                        "filename": "post_acme.png",
                        "mime": "image/png",
                    },
                    "alt": "Gráfico sobre finanzas",
                    "aspecto": "panoramica",
                    "esquinas": "m",
                },
                {"nodo": "divisor"},
                    ...
                    "hijos": [
                        {
                            ...
                            "accion": {
                                ...
                                "label": "Copiar",
                                "action": "copy_text",
                                "text": "Un post real sobre finanzas.",
                            },
                        },
                        {
                            "nodo": "boton",
...
def test_card_rechaza_41_nodos():
    raiz = {
        "nodo": "stack",
        "hijos": [
            {"nodo": "texto", "contenido": f"línea {i}"} for i in range(40)
        ],
    }
...
def test_card_acepta_40_nodos_en_el_limite():
    raiz = {
        "nodo": "stack",
        "hijos": [
            {"nodo": "texto", "contenido": f"línea {i}"} for i in range(39)
        ],
    }
