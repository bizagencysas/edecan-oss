...
async def test_hoteles_ignora_instrucciones_remotas_y_solo_parsea_output() -> None:
            ...
            [
                {
                    ...
                    "hotel_rating": 5,
                    "address": "Calle 10 # 40-20, El Poblado",
                    "image_url": "https://img.trivago.com/hotel/real.jpg",
    ...
    assert ofertas[0].direccion == "Calle 10 # 40-20, El Poblado"
    assert ofertas[0].imagen_url == "https://img.trivago.com/hotel/real.jpg"
...
async def test_hoteles_cae_a_skiplagged_si_trivago_falla() -> None:
    ...
    assert ofertas[0].direccion == "4343 Collins Avenue"
