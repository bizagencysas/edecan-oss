...
paquete). La telefonía Twilio básica es OSS: el cliente y el TwiML viven en
`edecan_voice.telephony`, y el router transaccional vive en `apps/api`.
La extensión opcional conserva únicamente funciones legadas como campañas,
SMS y Media Streams.
