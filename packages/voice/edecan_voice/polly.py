...
class PollyTTS(TTSProvider, ProveedorDeclarado):
    ...
    Declara `fidelidad=REAL` (`edecan_core.veracidad`): construirla ya exige
    `allow_ambient_credentials=True` explícito o una `session` inyectada (ver
    docstring del módulo) — nunca es un fallback silencioso."""
