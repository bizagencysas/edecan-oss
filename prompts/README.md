...
- [`persona_v3.md`](./persona_v3.md) — **versión vigente**: copia canónica de la capa de trato/tono del núcleo cognitivo 2.2 (`CORE_IDENTITY_ES` + bullets del Companion Layer en `packages/core/edecan_core/cognitive_architecture.py`), con changelog al pie. Prohíbe las coletillas de asistente ("¿Con qué quieres que te ayude?"...) y fija es-VE con tuteo, cero voseo. Versiones anteriores inmutables: [`persona_v2.md`](./persona_v2.md) (documenta además la plomería de la plantilla: formalidad, emojis, memorias, instrucciones delimitadas, reglas de seguridad) y [`persona_v1.md`](./persona_v1.md).
