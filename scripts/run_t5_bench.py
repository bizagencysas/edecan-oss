"""Ejecutor de la línea base T5 para el banco de pruebas de Edecán.

El banco fuente vive en `packages/forge-probe/bench/edecan.py`.

Ejecuta tareas triviales y standard contra `edecan_core.agent.Agent`,
...
# Estas importaciones deben ocurrir después de insertar los paquetes hermanos
# porque el script también se ejecuta directamente fuera de un entorno instalado.
from bench.edecan import _STANDARD, _TRIVIAL  # noqa: E402
from edecan_core.agent import Agent  # noqa: E402
from edecan_core.persona import PersonaConfig  # noqa: E402
from edecan_core.tools.base import ToolContext  # noqa: E402
from edecan_core.tools.registry import ToolRegistry  # noqa: E402
from edecan_llm.router import LLMRouter  # noqa: E402
...
async def main():
    ...
    for idx, tarea in enumerate(tareas, 1):
        ...
        for crit in tarea.criterios:
            ...
            criterios_evaluacion.append(
                {"descripcion": crit.descripcion, "pasa": pasa, "detalle": det}
            )
            if not pasa:
                tarea_paso = False
